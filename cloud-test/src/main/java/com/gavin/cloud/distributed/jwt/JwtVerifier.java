...
import com.gavin.cloud.distributed.jwt.cipher.Algorithm;
import com.gavin.cloud.distributed.jwt.cipher.CryptoHolder;
import com.gavin.cloud.distributed.jwt.cipher.SignerVerifierFactory;
import com.gavin.cloud.distributed.jwt.cipher.SignerVerifierHandler;
...
public class JwtVerifier {
    ...
    public JwtVerifier(String token) {
        ...
        this.header = new Header(JsonParser.parse(decodeFromBase64(parts[0])));
        this.payload = new Payload(JsonParser.parse(decodeFromBase64(parts[1])));
    }
